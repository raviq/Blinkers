...
QT_MOC_LITERAL(1, 8, 17), // "frameColorChanged"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 10), // "FrameColor"
QT_MOC_LITERAL(4, 38, 1) // "i"

    },
    "MyFrame\0frameColorChanged\0\0FrameColor\0"
    "i"
};
...
void MyFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->frameColorChanged((*reinterpret_cast< QColor(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyFrame::*)(QColor , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyFrame::frameColorChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyFrame::frameColorChanged(QColor _t1, int _t2)
{
